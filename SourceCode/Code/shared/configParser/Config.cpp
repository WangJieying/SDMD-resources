/* Modified by Yuri Meiburg, Mon 28 March 2011 */
...
bool Config::icompare_pred(unsigned char a, unsigned char b) {
    return std::tolower(a) == std::tolower(b);
}

bool Config::iequals(std::string const& a, std::string const& b) {
...
bool Config::pBool(string name) {
    ...
    return iequals(val, "yes") || iequals(val, "true");
}
